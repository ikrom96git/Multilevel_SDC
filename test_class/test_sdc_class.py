...
def test_sdc_without_force():
    problem_params, collocation_params, sweeper_params, problem_class = get_sdc_default_params()
...
def test_sdc_with_force():
    ...
    problem_params, collocation_params, sweeper_params, problem_class=get_sdc_default_params(Force=True)
    model = sdc_class(problem_params, collocation_params, sweeper_params, problem_class)
...
def test_sdc_residual(Force=False):
    ...
    K_iter = 10
    model_sdc_sweeper = sdc_class(problem_params, collocation_params, sweeper_params, problem_class)
...
def test_collocation_problem():
    ...
    problem_params, collocation_params, sweeper_params, problem_class = get_sdc_default_params(Force=True)
    model_collocation = sdc_class(problem_params, collocation_params, sweeper_params, problem_class)
...
def test_sdc_with_collocation_residual(Force=True):
    ...
    model_sdc = sdc_class(problem_params, collocation_params, sweeper_params, problem_class)
