...
from test_class.test_harmonicoscillator import get_harmonic_oscillator_test_params, get_harmonic_oscillator_test_force_params
...
def test_sdc_residual(Force=False):
    problem_params, collocation_params, sweeper_params = get_sdc_default_params(Force=Force)
    K_iter=10
