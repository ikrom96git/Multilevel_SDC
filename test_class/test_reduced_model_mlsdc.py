...
def test_mlsdc_fast_time_problems():
    ...
    problem_class_reduced=[problem_class[0], HarmonicOscillator_fast_time, HarmonicOscillator_fast_time_first_order]
    ...
    model_reduced_mlsdc=Mlsdc_class(problem_params_reduced, collocation_params, sweeper_params, problem_class_reduced)
